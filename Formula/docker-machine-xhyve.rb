class DockerMachineXhyve < Formula
  ...
  def install
    ...
    ENV["CGO_CFLAGS_ALLOW"] = "-arch*|x86_64*|-fmessage-length=152*|-fdiagnostics-show-note-include-stack*|-fmacro-backtrace-limit=0*"
    ENV["CGO_LDFLAGS_ALLOW"] = "-arch*|x86_64*|-fmessage-length=152*|-fdiagnostics-show-note-include-stack*|-fmacro-backtrace-limit=0*"
